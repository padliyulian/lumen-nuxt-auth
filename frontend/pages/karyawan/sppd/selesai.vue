...
<script>
    ...
    export default {
        ...
        created() {
            this.getSppd(`${process.env.apiUrl}/karyawan/sppd/selesai?page=1&length=${this.length}&column=${this.column}&dir=${this.dir}&search=${this.search}`)
        },
        ...
        methods: {
            ...
            lastPage() {
                this.getSppd(`${process.env.apiUrl}/karyawan/sppd/selesai?page=${this.data.last_page}&length=${this.length}&column=${this.column}&dir=${this.dir}&search=${this.search}`)
            },
